...
!function (e, t) {
  ...
  V.RegisterPlugins = function (e) {
    ...
    function c(e) {
      ...
      for (t in e) if (Object.prototype.hasOwnProperty.call(e, t)) {
        ...
        "style" === t && f.opts.htmlAllowedStyleProps.length && (r = e[t].match(h)), n && r ? e[t] = g(r.join(";")) : n && ("style" !== t || r) || delete e[t]
      }
    ...
    function v(e, t, n) {
      ...
      return f.opts.fullPage && (r = f.html.extractNode(e, "body") || (0 <= e.indexOf("<body") ? "" : e), n && (o = f.html.extractNode(e, "head") || "")), r = m(r, t), o && (o = m(o, t)), function a(e) {
        return e = (e = (e = e.replace(/\[FROALA\.EDITOR\.SCRIPT ([\d]*)\]/gi, function (e, t) {
          ...
          var n = l[parseInt(t, 10)].replace(/&lt;/g, "<").replace(/&gt;/g, ">"), r = C(n);
          if (r && r.length) {
            var o = m(r.html(), L);
      ...
      !function c(a) {
        ...
        if (f.opts.htmlAllowComments || a.nodeType !== Node.COMMENT_NODE) if (a.tagName && a.tagName.match(p)) "STYLE" == a.tagName && f.helpers.isMac() && function () {
          ...
          if (n) for (var r = n.length - 1; 0 <= r; r--) {
            ...
            "style" === o.nodeName && f.opts.htmlAllowedStyleProps.length && (s = o.value.match(h)), i && s ? o.value = g(s.join(";")) : i && ("style" !== o.nodeName || s) || a.removeAttribute(o.nodeName)
          }
    ...
    return {
      _init: function e() {
        ...
        !function s() {
          ...
          for (var e = f.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++) for (var n = f.node.contents(e[t]), r = null, o = n.length - 1; 0 <= o; o--) !n[o].tagName && f.opts.htmlUntouched || "LI" === n[o].tagName || "UL" == n[o].tagName || "OL" == n[o].tagName ? r = null : (r || (r = C(f.doc.createElement("LI"))).insertBefore(n[o]), r.prepend(n[o]))
        }(), function l() {
          var e, t, n;
          do {
            t = !1;
          ...
          for (var e = f.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
            var n = e[t];
            if (f.node.isFirstSibling(n) && "none" != n.parentNode.style.listStyleType) C(n).before("<br/>"); else if (n.previousSibling && "BR" === n.previousSibling.tagName) {
  ...
  V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), V.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", V.LinkRegExTLD = "((".concat(V.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), V.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(V.LinkRegExCommon, ")"), V.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(V.LinkRegExCommon, ")"), V.LinkRegExWWW = "(www\\.".concat(V.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), V.LinkRegEx = "(".concat(V.LinkRegExTLD, "|").concat(V.LinkRegExHTTP, "|").concat(V.LinkRegExWWW, "|").concat(V.LinkRegExAuth, ")").concat(V.LinkRegExEnd), V.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], V.MAIL_REGEX = /.+@.+\..+/i, V.MODULES.helpers = function (i) {
    ...
    function g(e, t, n, r, o) {
      ...
      var i = o ? l.shared.$_events : C, a = o ? l.sid : l.id,
    ...
    function t(e) {
      var t = a.$tb.find("[data-cmd=".concat(e, "]")), n = a.$tb.find("[data-cmd=html]");
      a.opts.trackChangesEnabled ? n && n.addClass("fr-disabled") : n && n.removeClass("fr-disabled"), function r(n) {
    ...
    return {
      _startEnter: function b(e) {
        var t, n = m(e), r = n.nextSibling, o = n.previousSibling, i = C.html.defaultTag();
        if (C.node.isEmpty(n, !0) && r) {
          ...
          for (p && "A" === p.tagName && (p = null); p && "LI" !== p.tagName;) f = C.node.openTagString(p) + f + C.node.closeTagString(p), p = p.parentNode;
          g(n).before("<li>".concat(f, "</li>")), g(e).remove()
        } else if (o) {
          t = v(n);
          for (var u = "".concat(V.MARKERS, "<br>"), h = e.parentNode; h && "LI" !== h.tagName;) u = C.node.openTagString(h) + u + C.node.closeTagString(h), h = h.parentNode;
          t.parentNode && "LI" === t.parentNode.tagName ? g(t.parentNode).after("<li>".concat(u, "</li>")) : i ? g(t).after("<".concat(i, ">").concat(u, "</").concat(i, ">")) : g(t).after(u), g(n).remove()
        ...
        for (var t = m(e), n = "", r = e, o = "", i = "", a = !1; r !== t;) {
          ...
          a || r == t || C.node.isBlock(r) || (a = !0, o += V.INVISIBLE_SPACE), o = C.node.openTagString(g(r).clone().addClass(s).get(0)) + o, i += C.node.closeTagString(r)
        }
        ...
        if (r) {
          ...
          if (s === C.el) return !1;
          if (s = s.nextSibling, C.node.isBlock(s)) {
            if (V.NO_DELETE_TAGS.indexOf(s.tagName) < 0) {
              if (g(e).replaceWith(V.MARKERS), (t = C.node.contents(n)).length && "BR" === t[t.length - 1].tagName && g(t[t.length - 1]).remove(), s.isContentEditable && "DIV" === s.tagName && (!C.node.isBlock(s.previousSibling) || "DIV" === s.previousSibling.tagName)) return;
              g(n).append(g(s).html()), g(s).remove()
            }
          } else {
    ...
    function u(e) {
      return !!e && (!!C.node.isBlock(e) || (e.previousSibling && e.previousSibling.nodeType === Node.TEXT_NODE && 0 === e.previousSibling.textContent.replace(/\u200b/g, "").length ? u(e.previousSibling) : !e.previousSibling && (!(e.previousSibling || !C.node.hasClass(e.parentNode, "fr-inner")) || u(e.parentNode))))
    }

    function h(e, t) {
      return !!e && (e !== C.$wp.get(0) && (e.previousSibling && e.previousSibling.nodeType === Node.TEXT_NODE && 0 === e.previousSibling.textContent.replace(/\u200b/g, "").length ? h(e.previousSibling, t) : !e.previousSibling && (e.parentNode === t || h(e.parentNode, t))))
    }
    ...
    function L(e) {
      ...
      n = n.previousSibling;
      var r = C.opts.htmlAllowedEmptyTags, o = n.tagName && n.tagName.toLowerCase();
      if ((!C.node.isBlock(n) || n.lastChild && o && 0 <= r.indexOf(o)) && C.node.isEditable(n)) {
        ...
        if (n.nodeType === Node.TEXT_NODE) {
          ...
          if (0 === n.textContent.length && n.previousSibling && "BR" === n.previousSibling.tagName && n.previousSibling.remove(), 0 === n.textContent.length) if (l && C.opts.keepFormatOnDelete) g(n).after(V.INVISIBLE_SPACE + V.MARKERS); else if (0 !== i.length && C.node.isBlock(n.parentNode)) g(n).after(V.MARKERS); else if ((2 != n.parentNode.childNodes.length || n.parentNode != e.parentNode) && 1 != n.parentNode.childNodes.length || C.node.isBlock(n.parentNode) || C.node.isElement(n.parentNode) || !C.node.isDeletable(n.parentNode)) {
            for (var c, d = n; !C.node.isElement(n.parentNode) && C.node.isEmpty(n.parentNode) && V.NO_DELETE_TAGS.indexOf(n.parentNode.tagName) < 0;) if ("A" === (n = n.parentNode).tagName) {
      ...
      } else if (V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (C.node.isEditable(n) || C.node.isDeletable(n))) if (C.node.isDeletable(n)) g(e).replaceWith(V.MARKERS), g(n).remove(); else if (C.node.isEmpty(n) && !C.node.isList(n)) g(n).remove(), g(e).replaceWith(V.MARKERS); else {
        for (C.node.isList(n) && (n = g(n).find("li").last().get(0)), (t = C.node.contents(n)) && 0 < t.length && "BR" === t[t.length - 1].tagName && g(t[t.length - 1]).remove(), t = C.node.contents(n); t && 0 < t.length && C.node.isBlock(t[t.length - 1]);) n = t[t.length - 1], t = C.node.contents(n);
        g(n).append(V.MARKERS);
        for (var u = e; !u.previousSibling;) u = u.parentNode;
        for (; u && "BR" !== u.tagName && !C.node.isBlock(u);) {
          var h = u;
          u = u.nextSibling, g(n).append(h)
        }
        u && "BR" === u.tagName && g(u).remove(), g(e).remove()
      } else e.nextSibling && "BR" === e.nextSibling.tagName && g(e.nextSibling).remove();
      return !0
    }

    function i(e) {
      var t = 0 < g(e).parentsUntil(C.$el, "BLOCKQUOTE").length, n = C.node.deepestParent(e, [], !t);
      ...
      if (null !== n) {
        ...
        if (C.node.isBlock(n) && (C.node.isEditable(n) || C.node.isDeletable(n)) && i && V.NO_DELETE_TAGS.indexOf(i.tagName) < 0) if (C.node.isDeletable(i)) g(i).remove(), g(e).replaceWith(V.MARKERS); else if (C.node.isBlock(i) && C.node.isEditable(i)) if (C.node.isList(i)) if (C.node.isEmpty(n, !0)) g(n).remove(), g(i).find("li").first().prepend(V.MARKERS); else {
          ...
          if ((o = C.node.contents(i)).length && "BR" === o[0].tagName && g(o[0]).remove(), "BLOCKQUOTE" !== i.tagName && "BLOCKQUOTE" === n.tagName) for (o = C.node.contents(n); o.length && C.node.isBlock(o[o.length - 1]);) n = o[o.length - 1], o = C.node.contents(n); else if ("BLOCKQUOTE" === i.tagName && "BLOCKQUOTE" !== n.tagName) for (o = C.node.contents(i); o.length && C.node.isBlock(o[0]);) i = o[0], o = C.node.contents(i);
    ...
    function n(e) {
      ...
      if ("BR" === (n = n.nextSibling).tagName && C.node.isEditable(n)) if (n.nextSibling) {
        ...
        if (v(e)) C.cursorLists._del(e); else C.node.deepestParent(n) && ((!C.node.isEmpty(C.node.blockParent(n)) || (C.node.blockParent(n).nextSibling && V.NO_DELETE_TAGS.indexOf(C.node.blockParent(n).nextSibling.tagName)) < 0) && g(n).remove(), i(e));
        return
      }
      ...
      } else if (V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (C.node.isEditable(n) || C.node.isDeletable(n))) if (C.node.isDeletable(n)) g(e).replaceWith(V.MARKERS), g(n).remove(); else if (C.node.isList(n)) e.previousSibling ? (g(n).find("li").first().prepend(e), C.cursorLists._backspace(e)) : (g(n).find("li").first().prepend(V.MARKERS), g(e).remove()); else if ((t = C.node.contents(n)) && 0 < t.length && "BR" === t[0].tagName && g(t[0]).remove(), t && 0 < t.length && "BLOCKQUOTE" === n.tagName) {
        var r = t[0];
    ...
    function E(e, t, n) {
      ...
      if (null === o) (r = C.html.defaultTag()) && C.node.isElement(e.parentNode) ? g(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : !e.previousSibling || g(e.previousSibling).is("br") || e.nextSibling ? g(e).replaceWith("<br>".concat(V.MARKERS)) : g(e).replaceWith("<br>".concat(V.MARKERS, "<br>")); else {
        var i = e, a = "";
        ...
        do {
          if (i = i.parentNode, !t || i !== o || t && !C.node.isBlock(o)) if (l += C.node.closeTagString(i), i === o && C.node.isBlock(o)) c = d + c; else {
    ...
    function y(e, t, n) {
      ...
      if (null === r) C.html.defaultTag() && e.parentNode === C.el ? g(e).replaceWith("<".concat(C.html.defaultTag(), ">").concat(V.MARKERS, "<br></").concat(C.html.defaultTag(), ">")) : (e.nextSibling && !C.node.isBlock(e.nextSibling) || g(e).after("<br>"), g(e).replaceWith("<br>".concat(V.MARKERS))); else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName) g(e).replaceWith("<" + C.html.defaultTag() + ">" + V.MARKERS + "<br></" + C.html.defaultTag() + ">"); else {
        var o = e, i = "";
        "PRE" === r.tagName && (t = !0), C.node.isBlock(r) && !t || (i = "<br>");
        var a = "", s = "";
        do {
          var l = o;
          if (o = o.parentNode, "BLOCKQUOTE" === r.tagName && C.node.isEmpty(l) && !C.node.hasClass(l, "fr-marker") && g(l).contains(e) && g(l).after(e), "BLOCKQUOTE" !== r.tagName || !m(e, o) && !h(e, o)) if (!t || o !== r || t && !C.node.isBlock(r)) {
            a += C.node.closeTagString(o);
            var c = "A" == o.tagName && m(e, o) || C.node.hasClass(o, "fa") ? "fr-to-remove" : "";
            s = C.node.openTagString(g(o).clone().addClass(c).removeAttr("id").get(0)) + s, C.opts.enter !== V.ENTER_DIV && o === r && "DIV" === r.tagName && (a = "<br>", s = "")
          } else "BLOCKQUOTE" == r.tagName && t && (s = a = "")
        } while (o !== r);
        var d = r === e.parentNode && C.node.isBlock(r) || e.nextSibling;
        if ("BLOCKQUOTE" === r.tagName) if (e.previousSibling && C.node.isBlock(e.previousSibling) && e.nextSibling && "BR" === e.nextSibling.tagName && (g(e.nextSibling).after(e), e.nextSibling && "BR" === e.nextSibling.tagName && g(e.nextSibling).remove()), t) i = a + i + V.MARKERS + s; else {
    ...
    return {
      enter: function S(e) {
        ...
        C.el.normalize();
        var r = !1;
        0 < g(t).parentsUntil(C.$el, "BLOCKQUOTE").length && (r = !0), g(t).parentsUntil(C.$el, "TD, TH").length && (r = !1), p(t) ? !v(t) || e || r ? E(t, e, r) : C.cursorLists._endEnter(t) : u(t) ? !v(t) || e || r ? function l(e, t, n) {
          var r, o = C.node.deepestParent(e, [], !n);
          if (o && "TABLE" === o.tagName) return g(o).find("td, th").first().prepend(e), l(e, t, n);
          if (o && "BLOCKQUOTE" === o.tagName) if (h(e, o)) {
          ...
          if (null === o) (r = C.html.defaultTag()) && C.node.isElement(e.parentNode) ? g(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : g(e).replaceWith("<br>".concat(V.MARKERS)); else {
            if (r = C.html.defaultTag(), C.node.isBlock(o)) if ("PRE" === o.tagName && (t = !0), t) g(e).remove(), g(o).prepend("<br>".concat(V.MARKERS)); else if (e.nextSibling && "IMG" == e.nextSibling.tagName || e.nextSibling && e.nextSibling.nextElementSibling && "IMG" == e.nextSibling.nextElementSibling) g(e).replaceWith("<" + C.html.defaultTag() + ">" + V.MARKERS + "<br></" + C.html.defaultTag() + ">"); else {
              if (C.node.isEmpty(o, !0)) return E(e, t, n);
              if (C.opts.keepFormatOnDelete || "DIV" === o.tagName || "div" === C.html.defaultTag()) if (!C.opts.keepFormatOnDelete && "DIV" === o.tagName || "div" === C.html.defaultTag()) g(o).before("<" + C.html.defaultTag() + "><br></" + C.html.defaultTag() + ">"); else if (C.opts.keepFormatOnDelete && "DIV" !== o.tagName && "div" !== C.html.defaultTag() && u(C.selection.get().focusNode)) g(o).before("".concat(C.node.openTagString(g(o).clone().removeAttr("id").get(0)), "<br>").concat(C.node.closeTagString(o))); else {
        ...
        }(t, e, r) : C.cursorLists._startEnter(t) : !v(t) || e || r ? y(t, e, r) : C.cursorLists._middleEnter(t), function c() {
        ...
        if (C.$oel[0].offsetHeight > o) {
          var i = function d() {
            var e = C.selection.get(), t = null;
            if (C.selection.inEditor() && e.rangeCount) for (var n = C.selection.ranges(), r = 0; r < n.length; r++) {
              var o = n[r];
        ...
        return p(t) ? v(t) && h(t, g(t).parents("li").first().get(0)) ? C.cursorLists._backspace(t) : e = L(t) : u(t) ? v(t) && h(t, g(t).parents("li").first().get(0)) ? C.cursorLists._backspace(t) : function c(e) {
          ...
          if (null !== n) {
            ...
            if (C.node.isBlock(n) && C.node.isEditable(n)) if (a && V.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
              if (C.node.isDeletable(a)) g(a).remove(), g(e).replaceWith(V.MARKERS); else if (C.node.isEditable(a)) if (C.node.isBlock(a)) if (C.node.isEmpty(a) && !C.node.isList(a)) g(a).remove(), g(e).after(C.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : ""); else {
                if (C.node.isList(a) && (a = g(a).find("li").last().get(0)), (i = C.node.contents(a)).length && "BR" === i[i.length - 1].tagName && g(i[i.length - 1]).remove(), "BLOCKQUOTE" === a.tagName && "BLOCKQUOTE" !== n.tagName) for (i = C.node.contents(a); i.length && C.node.isBlock(i[i.length - 1]);) a = i[i.length - 1], i = C.node.contents(a); else if ("BLOCKQUOTE" !== a.tagName && "BLOCKQUOTE" === r.tagName) for (i = C.node.contents(r); i.length && C.node.isBlock(i[0]);) r = i[0], i = C.node.contents(r);
                if (C.node.isEmpty(n)) g(e).remove(), C.selection.setAtEnd(a, !0); else {
        ...
        if (!e) return !1;
        if (C.el.normalize(), p(e)) if (v(e)) if (0 === g(e).parents("li").first().find("ul, ol").length) C.cursorLists._del(e); else {
    ...
    function v(e, t, n) {
      var r, o, i, a = {strong: {prop: "font-weight", val: "bold"}, em: {prop: "font-style", val: "italic"}};
      if (e) {
        ...
        if (e) {
          ...
          for (var l = e; l && !T(l).hasClass("fr-marker") && 0 === T(l).find(".fr-marker").length && "UL" !== l.tagName && "OL" !== l.tagName;) {
            var c = l;
            if ("SPAN" === l.tagName && T(l).hasClass("fr-tracking-deleted")) l = l.nextSibling; else {
          ...
          if (l) (T(l).find(".fr-marker").length || "UL" === l.tagName || "OL" === l.tagName) && v(l.firstChild, t, n); else {
    ...
    function r(e, t) {
      ...
      !function y(e, t, n, r) {
        for (var o, i = {
          ...
          var l = a[s];
          if (l.innerHTML && 8203 == l.innerHTML.charCodeAt() && l.tagName.toLocaleLowerCase() == n && l.childNodes.length < 2 && !M.helpers.isMobile() && (l.outerHTML = l.innerHTML), M.node.hasClass(l, "fr-marker")) t = (t + 1) % 2; else if (t) if (0 < T(l).find(".fr-marker").length) t = y(T(l), t, n, r); else {
            (o = "LI" === l.tagName ? l : T(l).parentsUntil(M.$el, "li").get(0)) && (void 0 === n || 0 <= ["strong", "em"].indexOf(n)) && (n ? T(o).css(i[n].prop, "") : o.style = ""), (o = l.parentNode !== M.el ? l.parentNode : null) && 1 === o.nodeType && "a" !== n && o.hasAttribute("style") && "SPAN" !== o.tagName && "LI" !== o.tagName ? o.style = "" : l && 1 === l.nodeType && "a" !== n && l.hasAttribute("style") && (l.style = "");
      ...
      if (l) {
        var c = M.node.blockParent(l), d = !!l.textContent.replace(/\u200B/g, "").length,
          f = M.win.getSelection().getRangeAt(0), p = f.startOffset, u = f.endOffset;
        ...
        var h = M.win.getSelection().getRangeAt(0);
        if (l.nodeType === Node.TEXT_NODE) {
          if (!d || !M.selection.text().length && p === u) {
            ...
            } else h.setStart(l, C), h.setEnd(l, C)
          }
        } else {
          var m, v, b = 0, L = T(l).contents();
          if (M.browser.msie) {
    ...
    function t(e, t) {
      ...
      if (M.selection.isCollapsed()) {
        ...
        if (M.node.openTagString(d.get(0)) === '<span style="'.concat(e, ": ").concat(d.css(e), ';">')) {
          if (M.node.isEmpty(d.get(0))) c = T(M.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)), d.replaceWith(c); else {
            var f = {};
        ...
        if (M.selection.save(), null === t || "color" === e && 0 < M.$el.find(".fr-marker").parents("u, a").length) {
          ...
          for (n = 0; n < p.length; n++) if (!0 === (r = T(p[n])).data("type") || "true" === r.data("type")) for (; M.node.isFirstSibling(r.get(0)) && !r.parent().is(M.$el) && !M.node.isElement(r.parent().get(0)) && !M.node.isBlock(r.parent().get(0));) r.parent().before(r); else for (; M.node.isLastSibling(r.get(0)) && !r.parent().is(M.$el) && !M.node.isElement(r.parent().get(0)) && !M.node.isBlock(r.parent().get(0));) r.parent().after(r)
        }
        for (var u = M.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling; u.firstChild;) u = u.firstChild;
        var h = {"class": "fr-unprocessed"};
        for (t && (h.style = "".concat(e, ": ").concat(t, ";")), v(u, "span", h), M.$el.find(".fr-marker + .fr-unprocessed").each(function () {
    ...
    function L(e, t, n) {
      ...
      if ((a = a.not(s)).length) {
        ...
        var u = "".concat(l + M.node.openTagString(T(a.get(0)).clone().css(t, n || "").get(0)) + f + e.css(t, "").get(0).outerHTML + d, "</span>").concat(c);
        e.replaceWith('<span id="fr-break"></span>');
        var h = a.get(0).outerHTML;
        T(a.get(0)).replaceWith(h.replace(/<span id="fr-break"><\/span>/g, function () {
          return u
        }))
      }
    }
        ...
        if (0 < a.length) {
          ...
          try {
            ...
            if (o.nextSibling === a || a.nextSibling === o) {
              ...
              for (var C = u.nextSibling; C && C.nodeType === Node.TEXT_NODE && 0 === C.length;) C = (d = C).nextSibling, y(d).remove();
              if (C && C.nodeType === Node.TEXT_NODE) for (; C && C.nextSibling && C.nextSibling.nodeType === Node.TEXT_NODE;) C.nextSibling.textContent = C.textContent + C.nextSibling.textContent, C = C.nextSibling, y(C.previousSibling).remove();
              if (h && (E.node.isVoid(h) || E.node.isBlock(h)) && (h = null), C && (E.node.isVoid(C) || E.node.isBlock(C)) && (C = null), h && C && h.nodeType === Node.TEXT_NODE && C.nodeType === Node.TEXT_NODE) {
                y(o).remove(), y(a).remove();
                var g = h.textContent.length;
                h.textContent += C.textContent, y(C).remove(), E.spaces.normalize(h), i.setStart(h, g), i.setEnd(h, g), l = !0
              } else !h && C && C.nodeType === Node.TEXT_NODE ? (y(o).remove(), y(a).remove(), E.opts.htmlUntouched || E.spaces.normalize(C), s = y(E.doc.createTextNode("\u200b")).get(0), y(C).before(s), i.setStart(C, 0), i.setEnd(C, 0), l = !0) : !C && h && h.nodeType === Node.TEXT_NODE && (y(o).remove(), y(a).remove(), E.opts.htmlUntouched || E.spaces.normalize(h), s = y(E.doc.createTextNode("\u200b")).get(0), y(h).after(s), i.setStart(h, h.textContent.length), i.setEnd(h, h.textContent.length), l = !0)
            }
            if (!l) {
      ...
      text: s, get: L, ranges: f, clear: S, element: function l() {
        ...
        try {
          if (e.rangeCount) {
            ...
            for (; r.nodeType !== Node.ELEMENT_NODE && r.parentNode || r.nodeType === Node.ELEMENT_NODE && "BR" === r.nodeName && r.parentNode;) r = r.parentNode;
        ...
        return E.el
      }, save: M, restore: T, isCollapsed: A, isFull: function d() {
        if (A()) return !1;
        E.selection.save();
        ...
        for (t = r.length - 1; 0 < t; t--) if (y(r[t - 1]).contains(r[t])) {
        ...
        return r
      }, info: o, setAtEnd: i, setAtStart: r, setBefore: function C(e, t) {
        void 0 === t && (t = !0);
    ...
    function e() {
      ...
      var e = f.opts.iframe ? f.$iframe.prev().outerHeight(!0) : f.$el.prev().outerHeight(!0), t = 0, n = 0, r = 0,
        o = 0, i = 0, a = 0, s = f.node.contents(f.el), l = p(f.selection.element()).css("text-align");
    ...
    return {
      defaultTag: d, isPreformatted: s, emptyBlocks: i, emptyBlockTagsQuery: function E() {
      ...
      }, getDoctype: w, set: function M(e) {
        var t = O.clean.html((e || "").trim(), [], [], O.opts.fullPage), n = new RegExp("%3A//", "g"),
          r = t.replace(n, "://");
        if (O.opts.fullPage) {
          var o = g(r, "body") || (0 <= r.indexOf("<body") ? "" : r), i = m(r, "body"),
            a = g(r, "head") || "<title></title>", s = m(r, "head"), l = h("<div>");
      ...
      }, syncInputs: D, get: function _(e, t) {
            ...
            if (c) for (var f = 0, p = c.length; f < p; f++) if (c[f].selectorText && 0 < c[f].style.cssText.length) {
              ...
              for (o = 0; o < h.length; o++) {
                ...
                for (var C = 1e3 * d + k(c[f].selectorText), g = c[f].style.cssText.split(";"), m = 0; m < g.length; m++) {
                  ...
                  if (v && !v.match(l) && (a[h[o]][v] || (a[h[o]][v] = 0) <= (h[o].getAttribute("fr-original-style") || "").indexOf("".concat(v, ":")) && (a[h[o]][v] = 1e4), C >= a[h[o]][v] && (a[h[o]][v] = C, g[m].trim().length))) {
                    var b = g[m].trim().split(":");
                    b.splice(0, 1), s.push([h[o], v.trim(), b.join(":").trim(), C])
                  }
                }
              }
            }
        ...
        if (O.node.isEmpty(O.el)) O.opts.fullPage && (n = w(O.iframe_document), n += "<html".concat(O.node.attributes(O.$html.get(0)), ">").concat(O.$html.find("head").get(0).outerHTML, "<body></body></html>")); else if (void 0 === e && (e = !1), O.opts.fullPage) {
          ...
          var M = O.opts.heightMin, T = O.opts.height, N = O.opts.heightMax;
        ...
        function e(e, t) {
          for (; t && (t.nodeType === Node.TEXT_NODE || !O.node.isBlock(t)) && !O.node.isElement(t) && !O.node.hasClass(t, "fr-inner") && !(t.nextSibling && ("BR" === t.nextSibling.nodeName || O.node.isBlock(t.nextSibling)) || t.previousSibling && ("BR" === t.previousSibling.nodeName || O.node.isBlock(t.previousSibling)) || O.node.hasClass(t.parentNode, "fr-view"));) t && t.nodeType !== Node.TEXT_NODE && h(e).wrapInner(O.node.openTagString(t) + O.node.closeTagString(t)), t = t.parentNode;
          t && e.innerHTML === t.innerHTML ? e.innerHTML = t.outerHTML : t.innerText && -1 != t.innerText.indexOf(e.innerHTML) ? e.innerHTML = O.node.openTagString(t) + t.innerHTML + O.node.closeTagString(t) : (t.nextSibling && ("BR" === t.nextSibling.nodeName || O.node.isBlock(t.nextSibling)) || t.previousSibling && ("BR" === t.previousSibling.nodeName || O.node.isBlock(t.previousSibling)) && t.wholeText) && (e.innerHTML = t.wholeText)
        }
        ...
        }(r)), O.node.isEmpty(O.el) && !O.opts.keepFormatOnDelete && f(r)) O.opts.trackChangesEnabled ? O.track_changes.pasteInEmptyEdior(r) : O.el.innerHTML = r; else {
          (function s() {
            var e = O.selection.ranges(0).commonAncestorContainer;
            return e !== O.el && !O.$el.contains(e)
          })() && O.selection.restore();
          var o = O.markers.insert();
          if (o) if (O.opts.trackChangesEnabled) O.track_changes.pasteInEdior(r); else {
      ...
      }, checkIfEmpty: o, extractNode: g, extractNodeAttrs: m, extractDoctype: v, cleanBRs: function B() {
    ...
    function l() {
      ...
      if (d.opts.height || d.opts.heightMax) {
        ...
        var t = d.selection.blocks(), n = null;
    ...
    function t(e) {
      ...
      if (e && e.clipboardData && e.clipboardData.getData) {
        ...
        if (A.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += "".concat(n[r], ";"); else t = n;
    ...
    function o(e, t, n) {
      ...
      }()) && (e = A.win.localStorage.getItem("fr-copied-html")), l) e = A.clean.html(e, A.opts.pasteDeniedTags, A.opts.pasteDeniedAttrs); else {
      ...
      if ("string" == typeof d && (e = d), "" !== e) {
        ...
        if (A.opts.enter === V.ENTER_BR) for (r = (o = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--) 0 === (i = o[r]).attributes.length && (i.outerHTML = i.innerHTML + (i.nextSibling && !A.node.isEmpty(i) ? "<br>" : "")); else if (A.opts.enter === V.ENTER_DIV) for (r = (o = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (i = o[r]).attributes.length && (i.outerHTML = "<div>".concat(i.innerHTML, "</div>")); else A.opts.enter === V.ENTER_P && 1 === f.childNodes.length && "P" === f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
        if (f.children && 0 < f.children.length) if (A.opts.trackChangesEnabled) for (var E = 0; E < f.children.length; E++) f.children[E].setAttribute("id", "isPasted"); else f.children[0].setAttribute("id", "isPasted");
    ...
    function $(e) {
      ...
      for (var r = f(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
        var o = r[r.length - 1];
        if (A.html.defaultTag() && "div" !== A.html.defaultTag()) o.querySelector(A.html.blockTagsQuery()) ? o.outerHTML = o.innerHTML : o.outerHTML = "<".concat(A.html.defaultTag(), ">").concat(o.innerHTML, "</").concat(A.html.defaultTag(), ">"); else {
    ...
    return {
      _init: function u() {
        A.el.addEventListener("copy", e), A.el.addEventListener("cut", e), A.el.addEventListener("paste", t, {capture: !0}), A.events.on("drop", r), A.browser.msie && A.browser.version < 11 && (A.events.on("mouseup", function (e) {
    ...
    function e(e) {
      ...
      "keydown" === e.type && (l = !1);
      var r = (e.shiftKey ? "^" : "") + (e.altKey ? "@" : "") + t, o = s.node.blockParent(s.selection.blocks()[0]);
    ...
    return {
      _init: function a() {
        ...
        if (n.undo_stack && !n.undoing && !n.el.querySelector(".fr-marker")) if (void 0 === e) {
    ...
    function e() {
      ...
      var e = !1;
      if (r.opts.fullPage) for (var t = r.$el.find("span,p,div"), n = 0; n < t.length; n++) if (t[n].style.height && t[n].style.height.includes("vh")) {
        e = !0;
        break
      }
    ...
    var h, C = u.shared.popups;

    function g(e, t) {
      t.isVisible() || (t = u.$sc), t.is(C[e].data("container")) || (C[e].data("container", t), t.append(C[e]))
    }
    ...
    function m(e) {
      return C[e] && u.node.hasClass(C[e], "fr-active") && u.core.sameInstance(C[e]) || !1
    }

    function v(e) {
      for (var t in C) if (Object.prototype.hasOwnProperty.call(C, t) && m(t) && (void 0 === e || C[t].data("instance") === e)) return C[t];
      return !1
    }

    function n(e) {
      var t = null;
      if (t = "string" != typeof e ? e : C[e], "filesManager.insert" === e && u.filesManager !== undefined && u.filesManager.isChildWindowOpen()) return !1;
    ...
    function c(e, t) {
      ...
      if (0 < i.length) {
        var a = u.helpers.getPX(o.find(".fr-color-set > span").css("width")), s = u.helpers.getPX(i.css("paddingLeft")),
        ...
        _windowResize: function () {
          ...
          if (!e.helpers.isMobile() && s.isVisible()) {
            ...
            if ("file.insert" === a && 0 < t.length && t.hasClass("fr-active")) {
              ...
              var r = u.button.getPosition(n), o = r.left, i = r.top;
              u.position.at(o, i, C[a], 0), e.events.enableBlur()
            } else e.events.disableBlur(), e.popups.hide(a), e.events.enableBlur()
          }
        }, _inputFocus: function (e) {
          var t = s.data("instance") || u, n = d(e.currentTarget);
          ...
          "mouseup" === e.type || d(n).is(":focus") || t.events.disableBlur(), "mouseup" !== e.type || d(n).hasClass("fr-command") || 0 < d(n).parents(".fr-command").length || d(n).hasClass("fr-dropdown-content") || u.button.hideActiveDropdowns(s), (u.browser.safari || u.browser.mozilla) && "mousedown" === e.type && d(n).is("input[type=file]") && t.events.disableBlur();
          ...
          if (!u.core.sameInstance(s)) return !0;
          var t = s.data("instance") || u, n = e.which;
          if (V.KEYCODE.ESC === n) {
          ...
          if (u.$wp && m(a) && s.parent().get(0) === u.$sc.get(0)) {
            var e = s.offset().top - u.$wp.offset().top, t = u.$wp.outerHeight();
            u.node.hasClass(s.get(0), "fr-above") && (e += s.outerHeight());
            var n = u.image.getEl(), r = n && n.get(0).getBoundingClientRect().top;
            (!u.opts.iframe && n && n.offset().top > t || t < e || e < 0) && (t + 100 < r || r < -90) ? s.addClass("fr-hidden") : s.removeClass("fr-hidden")
          }
    ...
    function f(e, t) {
      u.events.on("mouseup", e._editorMouseup, !0), u.$wp && u.events.on("keydown", e._editorKeydown), u.events.on("focus", function () {
        ...
        v() && u.markers.remove(), u.helpers.isMobile() ? C[t].hasClass("focused") ? (b(), C[t].removeClass("focused")) : C[t].addClass("focused") : C[t].find("iframe").length || b()
      }), u.$wp && !u.helpers.isMobile() && u.events.$on(u.$wp, "scroll.popup".concat(t), e._repositionPopup), u.events.on("window.mouseup", e._windowMouseup, !0), u.events.on("window.keydown", e._windowKeydown, !0), u.opts.iframe && window.addEventListener("click", e.handleWindowClick), C[t].data("inst".concat(u.id), !0), u.events.on("destroy", function () {
        u.core.sameInstance(C[t]) && (d("body").first().append(C[t]), C[t].removeClass("fr-active"))
      }, !0)
    }
    ...
    return u.shared.exit_flag = !1, {
      _init: function y() {
        ...
        }, !0), u.events.$on(d(u.o_win), "resize", r._windowResize, !0), "filesManager.insert" === e && C["filesManager.insert"].css("zIndex", 2147483641), n
      }, get: function M(e) {
        var t = C[e];
        return t && !t.data("inst".concat(u.id)) && f(E(e), e), t
      }, show: function T(e, t, n, r, o) {
        if (m(e) || (v() && 0 < u.$el.find(".fr-marker").length ? (u.events.disableBlur(), u.selection.restore()) : v() || (u.events.disableBlur(), u.events.focus(), u.events.enableBlur())), b([e]), !C[e]) return !1;
        var i = u.button.getButtons(".fr-dropdown.fr-active");
        i.removeClass("fr-active").attr("aria-expanded", !1).parents(".fr-toolbar").css("zIndex", "").find("> .fr-dropdown-wrapper").css("height", ""), i.next().attr("aria-hidden", !0).css("overflow", "").find("> .fr-dropdown-wrapper").css("height", ""), C[e].data("instance", u), u.$tb && u.$tb.data("instance", u);
        var a = m(e);
        C[e].addClass("fr-active").removeClass("fr-hidden").find("input, textarea").removeAttr("disabled");
        var s = C[e].data("container");
        if (function p(e, t) {
          t.isVisible() || (t = u.$sc), t.contains([C[e].get(0)]) || t.append(C[e])
        }(e, s), u.opts.toolbarInline && s && u.$tb && s.get(0) === u.$tb.get(0) && (g(e, u.$sc), n = u.$tb.offset().top - u.helpers.getPX(u.$tb.css("margin-top")), t = u.$tb.offset().left + u.$tb.outerWidth() / 2, u.node.hasClass(u.$tb.get(0), "fr-above") && n && (n += u.$tb.outerHeight()), r = 0), s = C[e].data("container"), u.opts.iframe && !r && !a) {
        ...
        a || u.accessibility.focusPopup(C[e]), u.opts.toolbarInline && u.toolbar.hide(), u.$tb && (h = u.$tb.find(".fr-btn-active-popup")), u.events.trigger("popups.show.".concat(e)), E(e)._repositionPopup(), L()
      }, hide: n, onHide: function N(e, t) {
        u.events.on("popups.hide.".concat(e), t)
      }, hideAll: b, setContainer: g, refresh: function A(e) {
        C[e].data("instance", u), u.events.trigger("popups.refresh.".concat(e));
      ...
      }, isVisible: m, setFileListHeight: o, areVisible: v, setPopupDimensions: function w(e, t) {
    ...
    function n(e, t, n) {
      if (f.shared.$f_el) {
        ...
        var o = s(C(e)), i = o.index(f.shared.$f_el);
    ...
    function o(c) {
      c && c.length && (f.events.$on(c, "keydown", function (e) {
        ...
        if (f.shared.with_kb = !0, f.browser.safari && f.shared.safariSelection) {
          var n = f.shared.safariSelection, r = n.startContainer, o = n.endContainer, i = n.startOffset,
            a = n.endOffset, s = f.doc.createRange();
    ...
    return {
      ...
      }, registerToolbar: o, focusToolbarElement: l, focusToolbar: u, focusContent: h, focusPopup: function M(r) {
  ...
  }, Object.assign(V.DEFAULTS, {tooltips: !0}), V.MODULES.tooltip = function (s) {
    var l = s.$;
    ...
    function o(e, t) {
      if (!s.helpers.isMobile()) {
        var n = e.attr("id") && e.attr("id").split("-")[0], r = e.attr("title");
        if ("trackChanges" === n) r = s.opts.trackChangesEnabled ? "Disable Track Changes" : "Enable Track Changes"; else if ("showChanges" === n) r = s.opts.showChangesEnabled ? "Hide Changes" : "Show Changes"; else if (("applyAll" === n || "removeAll" === n || "applyLast" === n || "removeLast" === n) && 0 === s.track_changes.getPendingChanges().length) return;
    ...
    return {
      hide: r, to: o, bind: function i(e, t, n) {
    ...
    function g(e, t) {
      var n, r = h();
      if (!e) return r;
      for (n in r = (r = r.add(l(a, e, t))).add(l(s, e, t)), C.shared.popups) if (Object.prototype.hasOwnProperty.call(C.shared.popups, n)) {
        var o = C.shared.popups[n].children().find(e);
        r = r.add(o)
      }
      for (n in C.shared.modals) if (Object.prototype.hasOwnProperty.call(C.shared.modals, n)) {
    ...
    function o(e) {
      var t = e.next(), n = C.node.hasClass(e.get(0), "fr-active"), r = g(".fr-dropdown.fr-active").not(e),
      ...
      if (!n) {
        ...
        if (!C.opts.toolbarBottom && t.offset().top + e.outerHeight() + i < h(C.o_doc).height()) t.css("top", e.position().top + e.outerHeight() - c); else {
    ...
    function m(e) {
      ...
      l = l ? " (".concat(l, ")") : "";
      var c = "".concat(e, "-").concat(C.id), d = "dropdown-menu-".concat(c),
      ...
      if ("dropdown" === t.type || "options" === t.type) {
        ...
        p += function u(e, t) {
          var n = "";
          if (t.html) "function" == typeof t.html ? n += t.html.call(C) : n += t.html; else {
            var r = t.options;
    ...
    return {
      _init: function b() {
        ...
        function o(e) {
          (!e || e.type === C._mouseup && e.target !== h("html").get(0) || "keydown" === e.type && (C.keys.isCharacter(e.which) && !C.keys.ctrlKey(e) || e.which === V.KEYCODE.ESC)) && (d(t), C.opts.iframe && function r(e) {
        ...
        C.events.$on(h(r), "".concat(C._mouseup, " resize keydown"), o, !0), C.opts.iframe && C.events.$on(C.$win, C._mouseup, o, !0), C.node.hasClass(t.get(0), "fr-popup") ? h.merge(s, t.find(".fr-btn").toArray()) : h.merge(a, t.find(".fr-btn").toArray()), C.tooltip.bind(t, ".fr-btn, .fr-title", e)
      }, refresh: function S(e) {
        var t, n = e.parents(".fr-popup, .fr-toolbar").data("instance") || C, r = e.data("cmd");
      ...
      }, bulkRefresh: n, exec: i, click: t, hideActiveDropdowns: d, addButtons: function M(e) {
        for (var t = 0; t < e.length; t++) a.push(e[t])
      }, getButtons: g, getPosition: function T(e) {
        var t = e.offset().left, n = C.opts.toolbarBottom ? 10 : e.outerHeight() - 10;
    ...
    function t(e) {
      if (e.offsetWidth) {
        var t = E(e), n = t.outerHeight(), r = t.data("sticky-position"),
          o = E("body" === L.opts.scrollableContainer ? L.o_win : L.opts.scrollableContainer).outerHeight(), i = 0,
          a = 0;
        ...
        var u = L.helpers.getPX(t.data("top")), h = L.helpers.getPX(t.data("bottom")), C = r.top && function v() {
    ...
    function s() {
      if (L.helpers.requestAnimationFrame()(s), !1 !== L.events.trigger("position.refresh")) for (var e = 0; e < L._stickyElements.length; e++) if (L.opts.toolbarBottom) {
        var t = L.$tb.parent(), n = t.get(0).offsetWidth - t.get(0).clientWidth, r = E(L._stickyElements[e]);
    ...
    return {
      ...
      }, refresh: n, at: i, getBoundingRect: o
    }
    ...
    function e(e) {
      var t = l.$tb.find('.fr-more-toolbar[data-name="'.concat(e.attr("data-group-name"), '"]')), n = function s(e, t) {
      ...
      undo: function t(e) {
        ...
        for (var t = l.selection.blocks(), n = 0; n < t.length; n++) {
          var r = "rtl" === l.opts.direction || "rtl" === c(t[n]).css("direction") ? "margin-right" : "margin-left",
            o = t[0].parentElement;
          if ("HTML" != o.parentNode.tagName && "P" != o.parentNode.tagName && "DIV" != o.parentNode.tagName && "UL" != o.parentNode.tagName && "OL" != o.parentNode.tagName && "LI" != o.parentNode.tagName) return i(e, !0), !0;
    ...
    function T() {
      for (var e = E.$tb.find(".fr-more-toolbar"), t = 0; t < e.length; t++) {
        ...
        c.hasClass("fr-expanded") ? function () {
          var n = E.helpers.getPX(c.css("padding-left")), e = c.find("> .fr-command, > .fr-btn-wrap"), t = S(e[0]),
            r = E.helpers.getPX(t.css("margin-left")), o = E.helpers.getPX(t.css("margin-right")),
            i = E.helpers.getPX(t.css("margin-top")), a = E.helpers.getPX(t.css("margin-bottom"));
    ...
    function r() {
      ...
      if (y !== E.helpers.screenSize()) {
        var i = M(), a = S(), s = S();
        for (var l in E.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command, .fr-btn-grp > .fr-btn-wrap > .fr-command, .fr-more-toolbar > .fr-btn-wrap > .fr-command").addClass("fr-hidden"), function L() {
          ...
          var c = i[l];
          if (c.buttons) {
            var d = void 0, f = 0, p = 3, u = void 0;
            "trackChanges" !== l && (u = S('<div class="fr-btn-grp fr-float-'.concat(i[l].align ? i[l].align : "left", '"></div>'))), i.showMoreButtons && (d = S('<div class="fr-more-toolbar"></div>').data("name", "".concat(l, "-").concat(E.id)), "trackChanges" !== l && "moreRich" !== l || !E.opts.trackChangesEnabled || d.addClass("fr-expanded"));
            for (var h = 0; h < c.buttons.length; h++) {
              c.buttonsVisible !== undefined && (p = c.buttonsVisible);
              var C = E.$tb.find('> .fr-command[data-cmd="' + c.buttons[h] + '"], > div.fr-btn-wrap > .fr-command[data-cmd="' + c.buttons[h] + '"]'),
                g = null;
              E.node.hasClass(C.next().get(0), "fr-dropdown-menu") && (g = C.next()), E.node.hasClass(C.next().get(0), "fr-options") && (C.removeClass("fr-hidden"), C.next().removeClass("fr-hidden"), C = C.parent()), C.removeClass("fr-hidden"), i.showMoreButtons && p <= f ? (d.append(C), g && d.append(g)) : (u.append(C), g && u.append(g)), f++
            }
            if (i.showMoreButtons && p < f) {
              var m = E.$tb.find('.fr-command[data-cmd="'.concat(l, '"]'));
              if (0 < m.length) m.removeClass("fr-hidden fr-open"); else {
                var v = l, b = V.COMMANDS[v];
  ...
  var c = ["scroll", "wheel", "touchmove", "touchstart", "touchend"], d = ["webkit", "moz", "ms", "o"],
    f = ["transitionend"], o = document.createElement("div").style, i = ["Webkit", "Moz", "ms", "O", "css", "style"],
    s = {visibility: "hidden", display: "block"}, r = ["focus", "blur", "click"], a = {}, l = function l(e, t) {
      return {
        altKey: e.altKey,
        bubbles: e.bubbles,
      ...
      return function (e) {
        var t = e.target;
        if (r) for (r = C(r); t && t !== this;) Element.prototype.matches.call(t, C(r)) && n.call(t, l(e, t)), t = t.parentNode; else p(t) && n.call(t, l(e, t))
      }
    }, h = function h(e, t) {
      return new v(e, t)
    }, C = function C(e) {
  ...
  h.fn = h.prototype = {
    constructor: h, length: 0, contains: function (e) {
      ...
      var t;
      return this[0] && (g(e) && (e = e.call(this[0])), t = h(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map(function () {
